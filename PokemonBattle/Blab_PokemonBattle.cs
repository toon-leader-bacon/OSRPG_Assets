...
public class Blab_PokemonBattle : MonoBehaviour
{
  ...
  void Start()
  {
    var playerMon = new BirdMon(speed: 50, maxHealth: 100, defense: 10, attack: 15, nickname: "Tweety");
    ...
    var computerMon = new CatMon(speed: 40, maxHealth: 120, defense: 12, attack: 18, nickname: "Whiskers");
    ...
    var battleManager = new BattleManager(playerTeam: playerTeam, computerTeam: computerTeam);
